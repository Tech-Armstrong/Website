                ...
                <div className="mt-10 flex items-center gap-6">
                  ...
                  <div className="flex items-center gap-3">
                    <button
                      type="button"
                      onClick={goPrev}
            className="focus-settle flex h-10 w-10 items-center justify-center rounded-full border border-white/30 text-white shadow-[var(--elevation-card)] transition-colors hover:border-white hover:bg-white/10 active:scale-[0.98]"
